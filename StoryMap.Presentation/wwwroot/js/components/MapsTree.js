          ...
          m("ul", [
            ...
            ...State.maps.map((map, mapIndex) => 
              m("li", [
                ...
                m("div", {
                  class: State.select.item ==='map' && State.select.index === mapIndex && State.select.nestedIndex === null ? 'selected' :
                         State.select.item ==='map' && State.select.index === mapIndex && State.select.nestedIndex === null && State.select.type === 'edit' ? 'inline-edit' : '', // Apply classes based on selection/edit state
                  onclick: (e) => {
                  ...
                  State.select.item ==='map' && State.select.index === mapIndex && State.select.nestedIndex === null && State.select.type === 'edit' ?
                    m("input[type='text']", {
                      value: map.name,
                      oninput: (e) => {
                ...
                m("ul", [
                  ...
                  ...map.images.map((image, imageIndex) => 
                    m("li", {
                      class: State.select.item ==='map' && State.select.index === mapIndex && State.select.nestedIndex === imageIndex ? 'selected' :
                             State.select.item ==='map' && State.select.index === mapIndex && State.select.nestedIndex === imageIndex && State.select.type === 'edit' ? 'inline-edit' : '', // Apply 'selected' or 'inline-edit' classes
                      onclick: (e) => {
                      ...
                      State.select.item ==='map' && State.select.type === 'edit' && State.select.index === mapIndex && State.select.nestedIndex === imageIndex ?
                        m("input[type='text']", {
                          value: image.src,
                          oninput: (e) => {
                            State.updateImageInMap(mapIndex, imageIndex, { src: e.target.value }); // Update the image source in the state
                          },
                          onfocus: (e) => {
                            e.target.select(); // Automatically select the text when entering edit mode
                          },
                          onkeydown: (e) => {
                            if (e.key === "Enter") {
                              State.updateImageInMap(mapIndex, imageIndex, { src: e.target.value }); // Save updated image src on Enter
                              e.target.blur(); // Remove focus to trigger blur event
                            }
                          }
                        }) : 
                      ...
                      State.select.item ==='map' && State.select.index === mapIndex && State.select.nestedIndex === imageIndex ?
                            ...
                            m("tr", [
                              ...
                              m("td", [
                                m("input[type='number']", {
                                  ...
                                  onkeydown: (e) => {
                                    if (e.key === "Enter") {
                                      State.updateImageInMap(mapIndex, imageIndex, { x: image.x });
                                    }
                                  }
                                })
                              ])
                            ...
                            m("tr", [
                              ...
                              m("td", [
                                m("input[type='number']", {
                                  ...
                                  onkeydown: (e) => {
                                    if (e.key === "Enter") {
                                      State.updateImageInMap(mapIndex, imageIndex, { y: image.y });
                                    }
                                  }
                                })
                              ])
                            ...
                            m("tr", [
                              ...
                              m("td", [
                                m("input[type='number']", {
                                  ...
                                  onkeydown: (e) => {
                                    if (e.key === "Enter") {
                                      State.updateImageInMap(mapIndex, imageIndex, { scale: image.scale });
                                    }
                                  }
                                })
                              ])
                            ...
                            m("tr", [
                              ...
                              m("td", [
                                m("input[type='number']", {
                                  ...
                                  onkeydown: (e) => {
                                    if (e.key === "Enter") {
                                      State.updateImageInMap(mapIndex, imageIndex, { rotation: image.rotation });
                                    }
                                  }
                                })
                              ])
                  ...
                  m("li", [
                    m("button.btn.btn-outline-primary.upload-btn", {
                      onclick: () => {
                        const newImage = { src: "new_image.jpg", x: 0, y: 0, scale: 1, rotation: 0 }; // New image structure
